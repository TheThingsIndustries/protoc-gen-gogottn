...
func main() {
	...
	for _, opt := range []func(*descriptor.FileDescriptorProto){
		...
		vanity.SetBoolFileOption(gogoproto.E_EqualAll, false),
		...
		vanity.SetBoolFileOption(gogoproto.E_MarshalerAll, false),
		...
		vanity.SetBoolFileOption(gogoproto.E_SizerAll, false),
		...
		vanity.SetBoolFileOption(gogoproto.E_UnmarshalerAll, false),
